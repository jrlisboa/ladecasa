    ...
    <body>
      ...
      <div class="tudo">
        ...
        <div class="topo row">
          ...
          <div class="logoGrande col l2 offset-l5">
        ...
        <div class="quemSomos row">
          ...
          <div class="textoContainer col l8 offset-l2">
            <span>Somos uma equipe composta por uma nutricionista e  ipsum dolor sit amet, consectetur adipiscing elit. In ultricies commodo est et imperdiet. Duis nec dui non tortor rhoncus bibendum vel sed dolor. Donec lobortis, tellus faucibus pharetra auctor, nisl nisl euismod leo, para dar condições de você ter todos os dias a melhor qualidade.</span>
          </div>


          <div class="galeria row">

            <div class="tituloGaleria col l3">
          ...
          <div class="btnBottom row">
            <span class="col l2 offset-l5" id="abreFotos">Ver todas as fotos</span>
          </div>
        ...
        <div class="chamada row">
          ...
          <a href="login"><span class="btnChamada col l2">Cadastre-se</span></a>
        ...
        <div class="row onde">
          ...
          <div class="textosOnde col l6 m6 s12">
            <span>Estamos localizados na Rua Guaraiúva, 268 Brooklin e você será sempre bem vindo para visitar nossas instalações .</span>
          ...
          $.ajax({
            ...
            success: function(dados){
              for(var i=1;3>=i;i++){
                ...
                //mostrando categoria
                $('#galeria').append('<div class="itemGaleria col l3"><img src="img/galeria/'+dados[i].imagem+'"></div>');       
              }
            }
          });
