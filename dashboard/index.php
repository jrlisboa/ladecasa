      ...
      <div class="tudo tudoDash row">
          ...
          <div class="col l10 offset-l2 s12 container row menus conteudoDash">
            ...
            <?php if ($_SESSION['pagamento'] == 0): ?>
                  <a style="margin-bottom: 20px;" href="../pagamento" class="btn col l6 offset-l3 s12 green white-text">FORMAS DE PAGAMENTO</a>
            <?php endif ?>          
            ...
            <a style="margin-top: 30px; margin-left: -10px" href="../favoritos/" class="btn col l11 s12 orange white-text">Escolher Produtos</a>
          </div>
              ...
              <div class="modal-content">
                ...
                <div class="modalPerfil col l12 s12">
                  ...
                  <div class="col l12">
                    ...
                    <a style="margin-top: 20px; box-shadow: none;" href="alterar_senha.php" class="col l4 s12 btn red white-text">Alterar senha</a>
