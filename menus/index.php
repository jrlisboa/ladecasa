              ...
              ?>
                ...
                <a href="../produtos/index.php?menu=<?= $res['id'] ?>" class="col l3 s12 linkMenu">
                  <div class="btnItem itemcardapios" style="height: 230px !important">
                    ...
                    <span class="col l8 offset-l2 s8 offset-s2 chip chipmenu" style="background-color: #1a1a1a; border: 2px solid <?= $res['cor'] ?> !important">&cong; R$<?= number_format($res['diario'], 2, ',', '.'); ?> / dia</span>
                  </div>
                </a>
